...
//imprting all the dependencies through npm i material table
//forwardref for takin function with refs
...
const api = axios.create({
  baseURL: `https://reqres.in/api`                  //fetching url through axios
})
